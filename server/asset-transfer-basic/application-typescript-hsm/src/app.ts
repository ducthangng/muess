...
async function main() {
  try {
    ...
    const hsmCAClient = new FabricCAServices(
      caInfo.url,
 ...
 */
async function interactWithFabric(
  contract: Contract,
  transactionToPerform: TransactionToSendFormat
): Promise<void> {
    ...
    switch (transactionToPerform.request) {
      case 'submit': {
        await contract.submitTransaction(
          transactionToPerform.txName,
          ...transactionToPerform.txArgs
        );
