    ...
    return (
        <>
            <div className='sign-in-container'
                ...
                {/* <div className='box-1' style={{ position: 'relative', backgroundColor: '#FFF7F1', height: 490, width: 479, top: 100, left: 309, borderRadius: '15px 0px 0px 15px' }}>
                ...
                <div className='box-2'
                    ...
                    <div className='signin-container' style={{ position: 'fixed', width: '23vw', height: "310px", top: '0px', left: '330px', backgroundColor: '#ffffff' }}>
                        <div className='SignIn' style={Sign}>Sign Up</div>
                        <div className='PersonalInfo' style={{ position: 'relative', display: 'flex' }}>Personal Information</div>
