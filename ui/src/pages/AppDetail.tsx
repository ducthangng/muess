            ...
            >
              ...
              <div>
                <i style={{ fontSize: '12px' }}>
                  ...
                  Media will (at its own cost) rectify any faults in the
                  Licensed Software notified to Joi Media during the duration of
                  the platform. This constitutes Licensee's sole remedy for
                  breaches of warranty under this Agreement.
                </i>
              </div>
            </div>
            {/* right card for license list */}
            <div
              className="w-[550px] h-[500px] p-5"
              style={{
                backgroundColor: '#ffffff',
                borderRadius: '10px',
                border: '1px solid #e8e8e8',
