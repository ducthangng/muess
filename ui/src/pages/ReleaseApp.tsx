...
const ReleaseApp = () => {
    ...
    return (
        <><SideMenu /><div className="Publish_Block">
            ...
            <div className="release-form-1">
                ...
                <div className='AppNameFill'>
                    ...
                    <div style={{ position: 'relative', top: '55px', left: '150px', fontWeight: 600, fontSize: '9px', lineHeight: '11px', color: '#A3A3A3', width:'fit-content' }}>This is how your app will appear on Müss</div>
                ...
                <div className='AppOrGame'>
                    ...
                    <div style={{ position: 'relative', top: '38px', left: '150px', fontWeight: 600, fontSize: '9px', lineHeight: '11px', color: '#A3A3A3' , width: 'fit-content'}}>You can change this later</div>
                    <label style={{ position: 'relative', top: '50px', left: '50px', fontWeight: 600, fontSize: '9px', lineHeight: '15px', color: '#3A001E', }}>
                        <input
                            type="radio"
                            name="choices1"
                            value="app"
                            className="form-check-input1" /><div className='AppBox'>App</div>
                ...
                <div className='FreeOrPaidOrRent'>
                    ...
                    <div style={{ position: 'relative', top: '23px', left: '150px', fontWeight: 600, fontSize: '9px', lineHeight: '11px', color: '#A3A3A3',width: 'fit-content' }}>You can change this later</div>
                    <label style={{ position: 'relative', top: '35px', left: '50px', fontWeight: 600, fontSize: '9px', lineHeight: '15px', color: '#3A001E', }}>
                        <input
                            type="radio"
                            name="choices2"
                            value="free"
                            className="form-check-input3" /><div className='FreeBox'>Free</div>
                ...
                <div style={{ width: '310px', position: 'absolute', left: '670px', top: '310px' }}>
                    <div style={{ position: 'relative', top: '28px', left: '-100px', fontWeight: 1000, fontSize: '12px', lineHeight: '15px', color: '#3A001E' }}>App icon</div>
                    <DragAndDrop />
                </div>
                <div style={{ width: '310px', position: 'absolute', left: '670px', top: '402px' }}>
                    <div style={{ position: 'relative', top: '28px', left: '-100px', fontWeight: 1000, fontSize: '12px', lineHeight: '15px', color: '#3A001E' }}>Images</div>
                    <DragAndDropMulti />
                </div>
                <button style={{ backgroundColor: '#FB7F4B', color: 'white', fontSize: '15px', position: 'absolute', top: '495px', left: '485px', borderRadius: '5px', width: '80px', height: '30px' }}>Release</button>
